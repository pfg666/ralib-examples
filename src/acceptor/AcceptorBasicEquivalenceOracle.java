...
/**
 * A very basic equivalence oracle
 */
public class AcceptorBasicEquivalenceOracle implements IOEquivalenceOracle  {
	...
	private double freshProb = 0.2;
	private List<ParameterizedSymbol> symbols;
	private DataWordOracle wordOracle;

	public AcceptorBasicEquivalenceOracle(DataWordOracle membershipOracle, Map<DataType, Theory> teachers, Constants consts,
			List<ParameterizedSymbol> symbols, ConstraintSolver solver, int bound, Random random) {
